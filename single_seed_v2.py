"""
Single Seed Neural Network v2

Start from ONE neuron. Let it crystallize into optimal geometry.

Key insight from working growing_field.py:
- Split on LOAD (how much work), not gradient conflict
- Load = activation_magnitude * responsibility
- A neuron doing too much work → should divide

Like a cell dividing when it grows too large.
"""
...
def train_single_seed(epochs=30, split_every=3):
    ...
    print("=" * 60)
    print("  SINGLE SEED NEURAL NETWORK")
